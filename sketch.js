...
var swordImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage,gameoverSound,kinfeSound;
...
function preload(){
  ...
  background1Image=loadImage("backgroundimage.jpg");
  gameoverSound=loadSound("gameover.mp3");
  kinfeSound=loadSound("knifeSwooshSound.mp3");
}
